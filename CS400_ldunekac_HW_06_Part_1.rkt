#lang racket
(define name "Luke Dunekacke")
(define user "ldunekace")
...
(define (jack x) (lambda (x) (set! a1 (+ a1 b1 x1)) (+ a1 b1 x1 x)))
(define (jill x) (lambda (x) (set! a1 (- a1 b1 x1)) (+ a1 b1 x1 x)))
...
(define (jack1 x) (lambda (x) (set! Ja (+ Ja Jb X1)) (+ Ja Jb Y1 x)))
(define (jill1 w) (lambda (w) (set! Jb (- Ja Jb X1)) (+ Ja Jb Y1 w)))
(define (adam y) (lambda (y) (set! Ja (+ Aa Ab X1)) (+ Aa Ab Y1 y)))
(define (abby z) (lambda (z) (set! Ab (- Aa Jb X1)) (+ Aa Ab Y1 z)))
